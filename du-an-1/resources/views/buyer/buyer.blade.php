...
{{--                                                <label>Nhớ đăng nhâp</label>--}}
                                            ...
                                            <div class="button-box btn-hover" >
                                                ...
                                                <a   class="btn button face-login" href="{{route('login.facebook')}}" ><i class="fab fa-facebook"></i>
                                                    Facebook</a>
                                ...
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form action="{{ route('buyer.insertUser') }}" id="form-register" method="post">
                                            ...
                                            <input type="email" id="input-email-register" name="email" placeholder="Email"
                                                   value="{{old('email')}}">
                                ...
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form action="{{route('buyer.postEmail')}}" id="post-email-forget" method="post">
                                            @csrf
                                            <input type="email" id="input-email-forget" name="email" placeholder="Nhâp email đã đăng ký"
                                                   value="{{old('email')}}">
