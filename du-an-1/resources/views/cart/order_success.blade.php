...
<div class="main" style="margin:0; padding:0">
    <div>
        <div class="center">
            <p align="center" style="font-size:2rem; color:#5d89af">Đặt hàng thành công, chúng tôi sẽ chuẩn bị cho đơn
                hàng của bạn nhanh nhất có thể </p>
            <a href="/shop" style="font-size:3rem; color:#5d89af; display:block; padding:0 150px; text-decoration:none; ">Tiếp tục mua sắm</a>
        </div>
